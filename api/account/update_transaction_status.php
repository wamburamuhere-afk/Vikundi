...
try {
    ...
    if ($result) {
        logActivity($pdo, $_SESSION['user_id'], "Updated transaction status to '$status' for entry ID: $entry_id");
    ...
    error_log("Error in update_transaction_status.php: " . $e->getMessage());
