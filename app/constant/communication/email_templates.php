...
<div class="container mt-4">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Manage system email notifications and response templates</p>
                </div>
                <div>
                    ...
                    <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#testEmailModal">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 text-primary">Template Library</h5>
    ...
    const table = $('#templatesTable').DataTable({
        ...
        ajax: {
            ...
            dataSrc: function(json) {
                ...
                // Update test email template dropdown
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    table.ajax.reload();
                    // Using a more consistent notification if exists, else alert
