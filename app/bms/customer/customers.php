                    ...
                    <div class="tab-content" id="registrationTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="personal" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Mkoa wa Kuzaliwa' : 'Region of Birth' ?></label>
                                    <input type="text" name="birth_region" class="form-control" placeholder="e.g. Mwanza">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Hali ya Ndoa' : 'Marital Status' ?></label>
                                    <select name="marital_status" id="marital_status_admin" class="form-select" onchange="toggleFamilyFieldsAdmin(this.value)">
                                        <option value="Single"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Hana Ndoa' : 'Single' ?></option>
                                        <option value="Married" selected><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Ana Ndoa' : 'Married' ?></option>
                                        <option value="Widowed"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Mjane' : 'Widowed' ?></option>
                                        <option value="Divorced"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Talaka' : 'Divorced' ?></option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Tarehe ya Kuzaliwa' : 'Date of Birth' ?></label>
                        ...
                        <div class="tab-pane fade" id="family" role="tabpanel">
                             ...
                             <div id="familyFieldsAdmin" style="display: none;">
                                ...
                                <div class="mb-4 pt-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Jina la Kwanza' : 'First Name' ?></label>
                                            <input type="text" name="spouse_first_name" class="form-control" placeholder="First Name">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Jina la Kati' : 'Middle Name' ?></label>
                                            <input type="text" name="spouse_middle_name" class="form-control" placeholder="Middle Name">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Jina la Mwisho' : 'Last Name' ?></label>
                                            <input type="text" name="spouse_last_name" class="form-control" placeholder="Last Name">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Barua Pepe' : 'Email' ?></label>
                                            <input type="email" name="spouse_email" class="form-control" placeholder="spouse@example.com">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Namba ya Simu' : 'Phone' ?></label>
                                            <input type="tel" name="spouse_phone" class="form-control" placeholder="0xxxxxxxxx">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Jinsia' : 'Gender' ?></label>
                                            <select name="spouse_gender" class="form-select">
                                                <option value=""><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Chagua...' : 'Select...' ?></option>
                                                <option value="Mwanaume"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Mwanaume' : 'Male' ?></option>
                                                <option value="Mwanamke"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Mwanamke' : 'Female' ?></option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Tarehe ya Kuzaliwa' : 'DOB' ?></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold small"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Namba ya NIDA' : 'NIDA Number' ?></label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="user_role" class="form-select form-select-sm">
                                        ...
                                        <option value="Admin"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Msimamizi (Admin)' : 'Admin' ?></option>
                                ...
                                <div class="form-text small opacity-75 mt-2 ms-2"><?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Mwanachama anaweza kubadilisha nenosiri na lugha baada ya kuingia mara ya kwanza.' : 'Member can change password and language after first login.' ?></div>
                            </div>
...
$(document).ready(function() {
    ...
    $('#addMemberForm').on('submit', function(e) {
        ...
        // Same format gate as the public registration — specific messages, no silent fail
        if (typeof validateRegistrationFormAdmin === 'function' && !validateRegistrationFormAdmin()) {
            return false;
        }
        ...
        if (!slipFile) {
            Swal.fire({
                icon: 'warning',
                title: '<?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Risiti Inahitajika!' : 'Receipt Required!' ?>',
                text: '<?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Tafadhali pakia risiti ya malipo (rekodi ya akiba ya awali) ili kukamilisha usajili huu.' : 'Please upload the payment slip (initial savings record) to complete this registration.' ?>',
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: '<?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Hitilafu' : 'Error' ?>',
                        text: response.message,
            ...
            error: function() {
                Swal.fire('<?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Hitilafu' : 'Error' ?>', '<?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Imeshindikana kuwasiliana na server.' : 'Server communication failed.' ?>', 'error');
                submitBtn.prop('disabled', false).html(originalBtnHtml);
            }
        });
    });
...
function togglePasswordAdmin(fieldId) {
    ...
    /* Registration format validation for the admin "Register New Member" form.
       Same rules as the public register.php (the server enforces them via the
       shared validate_registration_input). Reports the SPECIFIC problem live and
       on submit, jumping to the offending field — never a silent or late failure. */
    (function () {
        'use strict';
        ...
        var M = {
            en: {
                ...
                slipRequired:'Please upload the payment slip before submitting.',
                ...
                fee:'The amount must be a positive number.',
            ...
            sw: {
                ...
                slipRequired:'Tafadhali pakia risiti ya malipo kabla ya kutuma.',
                ...
                fee:'Kiasi lazima kiwe namba chanya.',
        ...
        function showError(input, message){
            ...
            if(!fb){ fb=document.createElement('div'); fb.className='reg-feedback text-danger small mt-1';
                fb.setAttribute('data-for', input.name); anchor.parentNode.insertBefore(fb, anchor.nextSibling); }
        ...
        function validPhone(v){ return /^\+?\d{9,13}$/.test(v.replace(/[\s\-()]/g,'')); }
        function checkEmail(i){ var v=i.value.trim(); if(v===''){clearError(i);return true;} if(!validEmail(v)){showError(i,msg('email'));return false;} clearError(i);return true; }
        function checkPhone(i){ var v=i.value.trim(); if(v===''){clearError(i);return true;} if(!validPhone(v)){showError(i,msg('phone'));return false;} clearError(i);return true; }
        ...
        function checkFee(i){ var v=i.value.trim(); if(v===''){clearError(i);return true;} if(isNaN(Number(v))||Number(v)<0){showError(i,msg('fee'));return false;} clearError(i);return true; }
        ...
        function checkSlip(req){
            var i=byName('kianzio_slip'); if(!i) return true;
            var f=i.files&&i.files[0];
            if(!f){ if(req){showError(i,msg('slipRequired'));return false;} clearError(i);return true; }
            var name=f.name.toLowerCase();
            var ok=/^(image\/jpeg|image\/png|application\/pdf)$/.test(f.type)||/\.(jpe?g|png|pdf)$/.test(name);
            if(!ok){showError(i,msg('slipType'));return false;} clearError(i);return true;
        }
        function checkPhoto(){
            var i=byName('passport_photo'); if(!i) return true;
            var f=i.files&&i.files[0]; if(!f){clearError(i);return true;}
            var name=f.name.toLowerCase();
            var typeOk=f.type==='image/jpeg'||f.type==='image/png'||/\.(jpe?g|png)$/.test(name);
            if(!typeOk){showError(i,msg('photoType'));return false;}
            if(f.size>2*1024*1024){showError(i,msg('photoSize'));return false;}
            clearError(i);return true;
        }
        function validateRegistrationFormAdmin(){
            var ok=true, first=null;
            function fail(el){ ok=false; if(!first&&el) first=el; }
            ...
            var fee=byName('initial_savings'); if(fee&&usable(fee)&&!checkFee(fee)) fail(fee);
            document.querySelectorAll('input[name="child_age[]"]').forEach(function(el){ if(usable(el)&&!checkChildAge(el)) fail(el); });
            if(!checkSlip(true)){ fail(byName('kianzio_slip')); }
            ...
            if(!ok&&first){
                ...
                setTimeout(function(){ try{first.focus();}catch(e){} },200);
                if(window.Swal) Swal.fire(msg('fixTitle'), msg('fixText'), 'warning');
            }
            return ok;
        }
        window.validateRegistrationFormAdmin = validateRegistrationFormAdmin;
        ...
        function setup(){
            attach(byName('email'), checkEmail);
            attach(byName('spouse_email'), checkEmail);
            ...
            attach(byName('first_name'), checkName);
            attach(byName('last_name'), checkName);
            attach(byName('nida_number'), checkNida);
            attach(byName('spouse_nida'), checkNida);
            attach(byName('initial_savings'), checkFee);
            var slip=byName('kianzio_slip'); if(slip) slip.addEventListener('change', function(){ checkSlip(false); });
