...
<head>
    ...
    <!-- Select2 Bootstrap 5 theme (self-hosted; §UI-3 theme:'bootstrap-5') -->
    <link href="<?= getUrl('assets/css/select2-bootstrap-5-theme.min.css') ?>" rel="stylesheet" />
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow border-0 mt-0" aria-labelledby="coreDropdown">
                                ...
                                <?php endif; ?>
                                <?php if (canView('manage_leadership_applications')): ?>
                                <li><a class="dropdown-item" href="<?= getUrl('manage_leadership_applications') ?>"><i class="bi bi-clipboard-check me-2" style="color:#6f42c1;"></i> <?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Pitia Maombi ya Uongozi' : 'Review Applications' ?></a></li>
                                <?php endif; ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow border-0 mt-0" aria-labelledby="financeDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= getUrl('mkoba_reconciliation') ?>"><i class="bi bi-clipboard-check text-primary me-2"></i> <?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Ulinganishaji wa M-Koba' : 'M-Koba Reconciliation' ?></a></li>
