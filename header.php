                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu shadow border-0 mt-0" aria-labelledby="coreDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= getUrl('manage_voting') ?>"><i class="bi bi-check2-square me-2" style="color:#6f42c1;"></i> <?= ($_SESSION['preferred_language'] ?? 'en') === 'sw' ? 'Simamia Kura' : 'Manage Voting' ?></a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
