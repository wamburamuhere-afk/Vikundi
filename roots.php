...
$routes = [
    ...
    'api/search_expense_members' => API_DIR . '/search_expense_members.php',
    'api/search_expense_members.php' => API_DIR . '/search_expense_members.php',
    ...
    'actions/fetch_pending_members' => ROOT_DIR . '/actions/fetch_pending_members.php',
    'actions/fetch_pending_members.php' => ROOT_DIR . '/actions/fetch_pending_members.php',
    ...
    'actions/mark_expense_paid' => ROOT_DIR . '/actions/mark_expense_paid.php',
    'actions/mark_expense_paid.php' => ROOT_DIR . '/actions/mark_expense_paid.php',
    'actions/save_document' => ROOT_DIR . '/actions/save_document.php',
    'actions/save_document.php' => ROOT_DIR . '/actions/save_document.php',
    'actions/sign_document' => ROOT_DIR . '/actions/sign_document.php',
    'actions/sign_document.php' => ROOT_DIR . '/actions/sign_document.php',
    'actions/manage_signatories' => ROOT_DIR . '/actions/manage_signatories.php',
    'actions/manage_signatories.php' => ROOT_DIR . '/actions/manage_signatories.php',
    'actions/save_writer_template' => ROOT_DIR . '/actions/save_writer_template.php',
    'actions/save_writer_template.php' => ROOT_DIR . '/actions/save_writer_template.php',
    'actions/delete_writer_template' => ROOT_DIR . '/actions/delete_writer_template.php',
    'actions/delete_writer_template.php' => ROOT_DIR . '/actions/delete_writer_template.php',
    'actions/delete_document' => ROOT_DIR . '/actions/delete_document.php',
    'actions/delete_document.php' => ROOT_DIR . '/actions/delete_document.php',
    ...
    'mkoba_reconciliation' => ACCOUNTS_DIR . '/mkoba_reconciliation.php',
    'mkoba-reconciliation' => ACCOUNTS_DIR . '/mkoba_reconciliation.php',
    'accounts/mkoba_reconciliation' => ACCOUNTS_DIR . '/mkoba_reconciliation.php',
    ...
    'contribution_statement'     => CUSTOMERS_DIR . '/contribution_statement.php',
    'contribution_statement.php' => CUSTOMERS_DIR . '/contribution_statement.php',
    ...
    'my_home'             => CUSTOMERS_DIR . '/my_home.php',
    'my_home.php'         => CUSTOMERS_DIR . '/my_home.php',
    ...
    // Meetings module
    'meetings' => MEETINGS_DIR . '/meetings.php',
    ...
    'documents_authored' => DOCUMENT_DIR . '/documents_authored.php',
    'documents_authored.php' => DOCUMENT_DIR . '/documents_authored.php',
    'edit_document' => DOCUMENT_DIR . '/edit_document.php',
    'edit_document.php' => DOCUMENT_DIR . '/edit_document.php',
    'view_document' => DOCUMENT_DIR . '/view_document.php',
    'view_document.php' => DOCUMENT_DIR . '/view_document.php',
    'writer_templates' => DOCUMENT_DIR . '/writer_templates.php',
    'writer_templates.php' => DOCUMENT_DIR . '/writer_templates.php',
    'edit_writer_template' => DOCUMENT_DIR . '/edit_writer_template.php',
    'edit_writer_template.php' => DOCUMENT_DIR . '/edit_writer_template.php',
    'api/get_writer_template' => API_DIR . '/get_writer_template.php',
    'api/get_writer_template.php' => API_DIR . '/get_writer_template.php',
    'api/search_document_members' => API_DIR . '/search_document_members.php',
    'api/search_document_members.php' => API_DIR . '/search_document_members.php',
    ...
    'communication/sms_center' => COMMUNICATION_DIR . '/sms_center.php',
    ...
    'sms_center' => COMMUNICATION_DIR . '/sms_center.php',
    'sms_center.php' => COMMUNICATION_DIR . '/sms_center.php',
    ...
    // SMS Settings
    'sms-settings' => SETTINGS_DIR . '/sms_settings.php',
    'sms_settings' => SETTINGS_DIR . '/sms_settings.php',
    'sms_settings.php' => SETTINGS_DIR . '/sms_settings.php',
    ...
    'audit-timeline' => ROOT_DIR . '/app/audit_timeline.php',
    'audit_timeline' => ROOT_DIR . '/app/audit_timeline.php',
    'user-timeline' => ROOT_DIR . '/app/audit_timeline.php',
    ...
    'api/export_contributions_statement' => API_DIR . '/export_contributions_statement.php',
    'api/export_contributions_statement_mkoba' => API_DIR . '/export_contributions_statement_mkoba.php',
    'api/save_transaction' => API_DIR . '/save_transaction.php',
    'api/search_customers' => API_DIR . '/search_customers.php',
    'api/get_guarantor_member' => API_DIR . '/get_guarantor_member.php', // registration PR-C: guarantor autofill
    'api/get_guarantor_member.php' => API_DIR . '/get_guarantor_member.php',
    ...
    'api/sms_center' => API_DIR . '/sms_center.php',
    'api/sms_center.php' => API_DIR . '/sms_center.php',
    'api/sms/save_settings' => API_DIR . '/sms/save_settings.php',
    'api/sms/save_settings.php' => API_DIR . '/sms/save_settings.php',
    'api/sms/test_connection' => API_DIR . '/sms/test_connection.php',
    'api/sms/test_connection.php' => API_DIR . '/sms/test_connection.php',
